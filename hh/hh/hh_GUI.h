...
class MainFrame : public wxFrame
{
	...
	public:
		MainFrame( wxWindow* parent, int id = -1, wxString title = wxT("hh"), wxPoint pos = wxDefaultPosition, wxSize size = wxDefaultSize, int style = wxDEFAULT_FRAME_STYLE );
};
...
class AboutDlg : public wxDialog
{
	...
	public:
		AboutDlg( wxWindow* parent, int id = -1, wxString title = wxT("About hh..."), wxPoint pos = wxDefaultPosition, wxSize size = wxDefaultSize, int style = wxDEFAULT_DIALOG_STYLE );
};
