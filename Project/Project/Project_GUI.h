...
///////////////////////////////////////////////////////////////////////////
#ifndef __Project_GUI__
#define __Project_GUI__
...
class MainFrame : public wxFrame
{
	...
	public:
		MainFrame( wxWindow* parent, int id = -1, wxString title = wxT("Project"), wxPoint pos = wxDefaultPosition, wxSize size = wxDefaultSize, int style = wxDEFAULT_FRAME_STYLE );
};
...
class AboutDlg : public wxDialog
{
	...
	public:
		AboutDlg( wxWindow* parent, int id = -1, wxString title = wxT("About Project..."), wxPoint pos = wxDefaultPosition, wxSize size = wxDefaultSize, int style = wxDEFAULT_DIALOG_STYLE );
};

#endif //__Project_GUI__
