...
function AddFilters(proj)
{
	try
	{
		// Agregar las carpetas al proyecto
		var strSrcFilter = wizard.FindSymbol('SOURCE_FILTER');
		var group = proj.Object.AddFilter('Archivos de código fuente');
...
function AddConfig(proj, strProjectName)
{
	try
	{
		...
		// TODO: agregar configuración del compilador

		var LinkTool = config.Tools('VCLinkerTool');
		// TODO: agregar configuración del vinculador
...
{
	// TODO: especificar configuración pch
}
...
function GetTargetName(strName, strProjectName)
{
	try
	{
		// TODO: establecer el nombre del archivo procesado en función del nombre de archivo de plantilla
	...
	try
	{
		...
		while (!strTextStream.AtEndOfStream)
		{
			...
			if (strTpl != '')
			{
				...
				var bCopyOnly = false;  //"true" sólo copia el archivo de strTemplate en strTarget sin procesarlo o agregarlo al proyecto
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFOhB1DaS35Ai
// SIG // JpU8adc0xdP+rsyhoIIe4TCCBBIwggL6oAMCAQICDwDB
...
// SIG // AQkEMRYEFNIbQNDKl0VQuHZHNcA7zViHGv+tMEQGCisG
// SIG // AQQBgjcCAQwxNjA0oBqAGABjAHUAcwB0AG8AbQB3AGkA
// SIG // egAuAGoAc6EWgBRodHRwOi8vbWljcm9zb2Z0LmNvbTAN
// SIG // BgkqhkiG9w0BAQEFAASCAQABK0xxnwDMVki+xzcirQLW
// SIG // rUl4Xxu+O/TQ7IwmMGw4qGrThhyDxHGM4JvoNfLwKP+/
// SIG // qC3XBO3Ub1yc31OGmG7uJx9WZAyVSX4tUjRH3WsEjvuu
// SIG // 7FXbu+USUPv1qkenlmkfRQTk+R5zlGDR6mD1fz97rFgH
// SIG // mLvidVR9O8flGq4wH+8fsgvb09OnL4H1Heam8INtjW1G
// SIG // hcfuTZBrQLSyX4lihHoP373bDPL1vICc8YNWFWfOczky
// SIG // mh5cvAfVCwsl3tYafzo9CmfJsOgbH8Yk0HnBSd5PskK1
// SIG // 5k0CgPZqZbynGuRh1q/Iho4YQTdE0M/k0TZJuNDBb4KE
// SIG // wkMLxX288SWaoYICHzCCAhsGCSqGSIb3DQEJBjGCAgww
...
// SIG // MDcxMjMwMjAzNTI4WjAjBgkqhkiG9w0BCQQxFgQUKOyO
// SIG // kTBYjVZOEunueQdlRg38BS8wDQYJKoZIhvcNAQEFBQAE
// SIG // ggEArF3QXy0uZe27KI6n5FT7nCnDcf/Nv7vKeDLztu1S
// SIG // n64z/vBiUffj+rWMSIJ3lus+MAx+lPmMP0MTm3v5H/yp
// SIG // e3jYSF1ylN0LAy04ZZQtWYGvwFpmSRNjPgMFtLfa4Ec7
// SIG // ITB6cYzT44YLHPhPUu//V7ZKUGGaGr6q376SuLUaNEz0
// SIG // SxNCEWHsoOKlUWcvhcdbacLkUCRTnhPG8HgmbTCVilvz
// SIG // H4lqP1F64H+WB5W33069QXBbD3VotLktiTwpyde2q1Tc
// SIG // aBXuhYRnAsQA6h49Q9bnIJ6RZJFqw7O7L8dAtmLm6J9r
// SIG // XJji30PpCdA1nBuIInEGfP7w66rceARfKVVUDg==
